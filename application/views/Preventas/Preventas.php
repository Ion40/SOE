													...
													foreach($prev as $key){
														echo "
															<tr>
																...
																<a class='dropdown-trigger btn-floating teal' href='#' data-target='dropdown".$key["IdUsuario"]."".$key["FechaEntrega"]."'><i class='material-icons'>edit</i></a>
	
																	<!-- Dropdown Structure -->
																	<ul id='dropdown".$key["IdUsuario"]."".$key["FechaEntrega"]."' class='dropdown-content'>";
																		if ($key["Estado"] == 0) {
