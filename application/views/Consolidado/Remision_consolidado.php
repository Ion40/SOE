		...
		<div class="contenedor-secundario">
			<table class="table-produccion">
                ...
                <tr>
                    ...
                    <td colspan="7">
                        <span style="font-size:11pt;">CONSOLIDADO DETALLE MANAGUA</span>
                    </td>
                </tr>
                <tr>
                    <td colspan="1" class="negrita" style="width:200px;">Ruta/Zona</td>
                    <td colspan="7">
                        <span style="font-size:11pt;">CONSOLIDADO TOTAL</span>
                    </td>
                </tr>
                <tr>
            ...
            <div class="contenedor-secundario">
                <table class="table-produccion">
                    <thead>
                        <tr>
                             <th colspan="3"></th>
                            <th colspan="2" class="black">PEDIDO</th>
                            ...
                            if (!$remision) {
                                ...
                                foreach ($remision as $key) {
                                    echo "
                                        <tr>
                                            <td>".$key["Codigo"]."</td>
                                            <td style='text-align:left; width: 500px;'>".$key["Descripcion"]."</td>
                                            <td>".$key["GRM"]."</td>
                                            <td>".$key["Unidades"]."</td>
                                            <td>".$key["LBS"]."</td>
                                            <td></td>
