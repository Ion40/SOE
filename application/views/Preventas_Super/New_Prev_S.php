			...
			<div class="row">
				...
				<div class="row">
					<div class="col s12 m12 l6">
						<a href="#"  id="GuardarOrden" onclick="guardar();" class="btn btn-block btn-blue waves-effect waves-light hoverable right">Guardar</a>
					</div>
				</div>
				<div class="col s12 m12 l12" >
					<div class="card">
						<div class="card-content">
							<div class="div-cont">
								<div class="row"><div class="col s6 m6 l3 right">
										<select name="idClientes" id="idClientes" class="browser-default chosen-select">
								...
								<div>
									<table id="tblNuevaOrdenPrevS" class="table striped" style="height:20px !important;">
										<thead>
