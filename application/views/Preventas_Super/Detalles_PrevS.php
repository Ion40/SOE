												...
												echo "
                                                            <tr>
                                                                ...
                                                                <td class='center-align'>
                                                                   ...
                                                                   <a href='javascript:void(0)'
                                                                   onclick='DetOrdPrevSxCli(".'"'.$key["IdCliente"].'","'.$key["FechaEntrega"].'","'.$key["Vendedor"].'","'.$key["Cliente"].'","'.$key["Estado"].'"'.")'>
...
<div id="modalDetalleOrderS" class="modal">
	<div class="modal-content">
		<div class="row">
			...
			<br><br><br>
			<div class="col s12 m12 l12">
				<table id="tblDetalleOrderPrevS" class="table striped">
...
<div id="modalEditOrderS" class="modal modal-fixed-footer">
	<div class="modal-content">
		...
		<div class="row">
			<div class="col s12 m12 l12">
				<table id="tblEditarOrdenPrevS" class="table striped">
					<thead>
					<tr class="tblcabecera">
						<th>Codigo</th>
						<th>Productos</th>
