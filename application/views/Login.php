...
<body class="avoid-fout page-blue ">
	<header class="header" style="margin-top:0px;">		
		<img src="<?php echo base_url('assets/img/logo.png');?>" style="height:100%;">
		<p class="right-align" style="margin-top:-85px; text-align: right;">
				<img src="<?php echo base_url('assets/img/delmor.png');?>" class="center" width="150px">
			</p>
	</header>
									...
									<div class="card-inner">
										<p class="text-center">
											<span class="avatar avatar-inline avatar-lg">
												<img alt="Login" src="<?php echo base_url('assets/img/avatar-001.jpg');?>">
											</span>
										</p>
