	...
	<div class="contenedor">
        ...
        //////////////////////////////////////////////////////////////////////////////////////////-->
			<div class="row">
                ...
                <div id="retornarP">
                     <a data-tooltip='REGRESAR' href="Ordenes" class="purple-text darken-1 tooltipped">
            ...
            <div class="row">
                    <div class="col s12 m12 l6">
                        <a href="#" onclick="guardar()" id="GuardarOrden" class="btn btn-block btn-blue waves-effect waves-light hoverable right">Guardar</a>      
                    </div>       
                </div>
				<div class="col s12 m12 l12" >
					<div class="card">
						<div class="card-content">
                            ...
                            <div class="row">
								...
								<div>
                                    <table id="tblNuevaOrden" class="table striped" style="height:20px !important;">
                                        <thead>
